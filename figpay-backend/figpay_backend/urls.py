...
router.register("payments/consumers", ConsumerPaymentViewset, base_name='consumer_payments')
router.register("payments/vendors", VendorPaymentViewset, base_name='vendor_payments')
